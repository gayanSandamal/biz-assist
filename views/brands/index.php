...
$result_view_brands = $conn->query($view_brands);
?>
                        ...
                        <form method="POST" action="delete-multiple.php">
                            <div class="card-header" data-background-color="purple">
                                <h4 class="title">
                                    <div class="title-text">
                                        <a href="add.php">Add new generic</a>
                            ...
                            <div class="card-content table-responsive">
                                <table class="table hover" id="cat-table">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($result_view_brands->num_rows > 0) {
// output data of each row
                                            $numOrder = 1;
                                            while ($row = $result_view_brands->fetch_assoc()) {
                                                ?>
                                                ...
                                                <tr class="product-single-container">
                                                    <th class="product-select">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="check_list[]" value="<?php echo $row["brand_id"]; ?>" class="cat-check">
                                                            </label>
                                                        </div>
                                                    </th>
                                                    ...
                                                    <td class="product-actions">
                                                        <a href="edit.php?id=<?php echo $row["brand_id"]; ?>" class="product-actions-btn product-actions-edit"><i class="material-icons">mode_edit</i><span>Edit</span></a>
                                                        <a href="<?php echo $row["brand_id"]; ?>" class="product-actions-btn product-actions-delete" id="brand-actions-delete"><i class="material-icons">delete</i><span>Delete</span></a>
                                                    </td>
                                                </tr>
...
<script>
    ...
    $('a#brand-actions-delete').click(function (e) {
        e.preventDefault();
