...
";
$result_get_customers = $conn->query($get_customers);
?>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title"><a href="<?php echo $baseUrl; ?>/views/customers/" class="back-btn"><i class="material-icons">arrow_back</i></a>Edit Customer</h4>
                            <!--<p class="category">Complete your profile</p>-->
                        </div>
                        <div class="card-content">

                            <?php
                            if ($result_get_customers->num_rows > 0) {
                                    ...
                                    <form class="min-height-form" method="get" action="../../controllers/edit-supplier-call.php">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating">
                                                ...
                                                <input type="text" class="form-control customer-name from-display-name name-required required"  name="customer_name" value="<?php echo $row["customer_name"]; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Customer contact no</label>
                                                <input type="text" maxlength="9" class="form-control from-display-name number" name="customer_no" id="from-display-name" onkeyup="show_matching_cats()" value="<?php echo $row["phone"]; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Customer NIC</label>
                                                <input type="text" maxlength="10" class="form-control" name="customer_nic" id="customer_nic" value="<?php echo $row["nic"]; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Supplier email</label>
                                                <input type="text" class="form-control from-display-name email"  name="customer_email" id="customer_email" value="<?php echo $row["email"]; ?>">
                                            </div>
                                        </div>
                                        <input type="hidden" value="<?php echo $row["customer_id"]; ?>" name="customer_id"/>
                                        <button type="submit" class="btn btn-primary pull-right edit-supplier-button" id="edit-supplier-button">Edit customer</button>
                                        <div class="clearfix">
                                        </div>
                                    </form>
                                    <?php
...
//            } else {
            $.ajax({
                type: 'get',
                url: '../../controllers/edit-customer-call.php',
                data: $('form').serialize(),
