...
<div class="col-md-12">
    <div class="card">
        <div class="card-header" data-background-color="purple">
            <h4 class="title">
                <!--<a href="<?php // echo $baseUrl;    ?>/views/customers/" class="back-btn"><i class="material-icons">arrow_back</i></a>-->
                Add Customer</h4>
            ...
            <form class="min-height-form" method="get" action="add-supplier-call.php">
                ...
                <div class="col-md-6">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" maxlength="9" class="form-control number-required from-display-name number" name="customer_no" id="from-display-name">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group label-floating">
...
//    }
    ...
    $('#add-supplier-button').on('click', function (e) {
        ...
        if (name_required.val().length > 0) {
            $.ajax({
                type: 'get',
                url: baseUrl + '/views/customers/add-customer-call.php',
                data: $('form').serialize(),
