                                            ...
                                            while ($row = $result_view_sales->fetch_assoc()) {
                                                ...
                                                <tr class="product-single-container">
                                                    <th class="product-select">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="check_list[]" value="<?php echo $row["customer_mobile_number"]; ?>" class="cat-check">
                                                            </label>
                                                        </div>
                                                    </th>
                                                    <td class="product-id"><span><?php echo ($numOrder++); ?></span></td>
                                                    <!--====================================================-->
                                                    <td class="product-name-td"><div class="product-name"><a href="#" class="sale-detail" onclick="sale_details(<?php echo $row["customer_mobile_number"]; ?>)"><?php echo $row["hold_id"]; ?></a></div></td>
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["customer_mobile_number"]; ?></div></td>
...
<!--                                                        <a href="edit.php?id=<?php // echo $row["invoice_id"];      ?>" class="product-actions-btn product-actions-edit"><i class="material-icons">mode_edit</i><span>Edit</span></a>-->
                                                        <a href="<?php echo $row["customer_mobile_number"]; ?>" class="product-actions-btn product-actions-delete" id="held-actions-delete"><i class="material-icons">delete</i><span>Delete</span></a>
                                                    </td>
                                                </tr>
...
<script>
    ...
    $('a#held-actions-delete').click(function (e) {
        e.preventDefault();
