                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <!--<h4 class="title"><a href="<?php // echo $baseUrl; ?>/views/user-management/" class="back-btn"><i class="material-icons">arrow_back</i></a>Edit User</h4>-->
                            ...
                            <form class="min-height-form" method="get">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control from-display-name username-required required"  name="username" id="from-display-name" onkeyup="show_matching_cats()" value="<?php echo $username; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">First name</label>
                                        <input type="text" class="form-control first-name-required required"  name="firstname" value="<?php echo $first_name; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Last name</label>
                                        <input type="text" class="form-control last-name-required required"  name="lastname" value="<?php echo $last_name; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Phone</label>
                                        <input type="tel" class="form-control phone-required required"  name="phone" value="<?php echo $phone; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Email</label>
                                        <input type="tel" class="form-control email-required required"  name="email" value="<?php echo $email; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <select class="form-control search-filter" id="search-filter-locator" name="locator">
                                            <option selected value="<?php echo $branch_id; ?>"><?php echo $branch_name . "(" . $branch_location . ")"; ?></option>
                                            <?php
...
<!--                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <select class="form-control search-filter" id="search-filter-userlevel" name="userlevel">
                                            <option selected value="<?php // echo $user_level_id; ?>"><?php // echo $user_level; ?></option>
                                            <?php
...
//                                            }
                                ...
                                <button type="submit" class="btn btn-primary pull-right add-user-button" id="edit-user-button">Update profile</button>
                                <div class="clearfix">
                                </div>
                            </form>
                        </div>
...
<!--                            <p class="card-description">
                            ...
                            <a class="btn btn-primary btn-round" id="update_profile-alt-btn">Update profile</a>
                        </div>
                    </div>
                </div>
            </div>
...
//        refresh_cat_list();
        ...
        $('#update_profile-alt-btn').on('click', function(e){
            e.preventDefault();
            $('#edit-user-button').trigger('click');
        });
    });
...
//        $('input').val("");
    ...
    $('#edit-user-button').on('click', function (e) {
        ...
        if ((username_required.val().length > 0) && (first_name_required.val().length > 0) && (last_name_required.val().length > 0) && (phone_required.val().length > 0) && (email_required.val().length > 0)) {
...
//                } else {
            $.ajax({
                type: 'get',
                url: '../../controllers/edit-profile-call.php',
                data: $('form').serialize(),
