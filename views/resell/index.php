...
s.item_count,
s.item_name,
s.alt_buy AS buying_price,
s.item_price AS selling_price,
s.alt_profit AS profit,
s.alt_notes AS details,
u.first_name
FROM sale_details s
                            ...
                            <div class="card-header" data-background-color="purple">
                                <h4 class="title">
                                    <div class="title-text">
                                        <!--<a href="add.php">Add new reselling item</a>-->
                                        Reselling history
                                        <!--Sale details-->
...
<!--                                    <div class="edit-mode-check">
                            ...
                            <div class="card-content table-responsive">
                                <table class="table hover" id="cat-table">
                                    ...
                                    <th style="white-space:nowrap;">Invoice Ref. No.</th>
                                    <th>Date</th>
                                    <th style="white-space:nowrap;">Product name</th>
                                    <th>Qty</th>
                                    <th style="white-space:nowrap;">Bought price</th>
                                    <th style="white-space:nowrap;">Sold price</th>
                                    <th>Profit</th>
                                    <th>Details</th>
...
// output data of each row
                                            ...
                                            while ($row = $result_view_sales->fetch_assoc()) {
                                                ...
                                                <tr class="product-single-container">
                                                    ...
                                                    <!--====================================================-->
                                                    <td class="product-name-td"><div class="product-name"><a class="sale-detail"><?php echo $row["invoice_ref_no"]; ?></a></div></td>
                                                    
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["invoice_time"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["item_name"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["item_count"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name text-right">Rs.<?php echo $row["buying_price"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name text-right">Rs.<?php echo $row["selling_price"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name text-right">Rs.<?php echo $row["profit"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["details"]; ?></div></td>
                                                    <!--========================================================-->
<!--                                                    <td class="product-actions">
                                                        ...
                                                        <a href="<?php // echo $row["invoice_id"]; ?>" class="product-actions-btn product-actions-delete" id="product-actions-delete"><i class="material-icons">delete</i><span>Delete</span></a>
                                                    </td>-->
                                                </tr>
