...
<div class="main-panel shop-page">
    ...
    <div class="content">
                        ...
                        <div class="shop-item <?php echo ($row["availability"] == 1 ? 'available' : 'not-available'); ?> visual-id-<?php echo $row["product_id"]; ?>" onclick="add_to_invoice('<?php echo ($row["availability"] == 1 ? '1' : '0'); ?>', '<?php echo $row["product_id"]; ?>')" id="<?php echo $row["product_id"]; ?>" data-category="<?php echo $row["cat_name"]; ?>">
                            <div class="shop-item-container">
                                <div class="shop-item-top">
                                    <div class="shop-item-top-img" style="background-image: url(<?php echo ($row["img_path"] != '' ? $baseUrl . $row["img_path"] : $baseUrl . '/assets/img/placeholder-image.png'); ?>);">
                                        ...
                                        <div class="shop-item-top-img-content">
                                            ...
                                            <h5 class="shop-item-top-title">
                                                <span class="shop-item-name"><?php echo $row["product_name"]; ?>-<?php echo $row["product_model_no"]; ?></span> (<span class="shop-item-count"><?php echo $row["qty"]; ?></span>) <div class="condition-tag">
                                                    <?php
        ...
        <!--                                            <a class="shop-item-bottom-controller-details" href="<?php // echo $row["product_id"];                                                                                                                               ?>">
...
`;
        ...
        if (item_tr.length > 1) {
            ...
            item_tr.find('input.invoice-cart-single-count').on('change keyup', function () {
                ...
                item_tr.find('.invoice-cart-single-total > span').text(item_single_total);
            });
        } else {
            cartItem_count -= 1;
            item_tr.find('input.invoice-cart-single-count').on('change keyup', function () {
...
//    single discount
    function single_discount(item_id) {
        ...
        $('table.invoice-cart-table tbody tr#' + item_id + ' .invoice-cart-single-total > span').text(single_discounted_price);
        calc_warn();
    }
//    single discount
...
<div class="proceed-form-container">
  <div class="proceed-form">
    ...
    function getBalance() {
        ...
        $('#balance_input').val(balance_amount);
        $('#cash_span').text(cash_amount);
        $('#balance_span').text(balance_amount);
    }
