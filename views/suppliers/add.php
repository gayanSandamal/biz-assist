                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title"><a href="<?php echo $baseUrl; ?>/views/suppliers/" class="back-btn"><i class="material-icons">arrow_back</i></a>Add Supplier</h4>
                            ...
                            <form class="min-height-form" method="get" action="add-supplier-call.php">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control from-display-name name-required required"  name="supplier_name" id="from-display-name" onkeyup="show_matching_cats()">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Supplier contact no</label>
                                        <input type="text" maxlength="9" class="form-control from-display-name number" name="supplier_no" id="supplier_no" onkeyup="show_matching_cats()">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Supplier email</label>
                                        <input type="text" class="form-control from-display-name email"  name="supplier_email" id="supplier_email" onkeyup="show_matching_cats()">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary pull-right add-supplier-button" id="add-supplier-button">Add category</button>
                                <div class="clearfix">
                                </div>
                            </form>
                        </div>
