                                            ...
                                            while ($row = $result_view_suppliers->fetch_assoc()) {
                                                ...
                                                <tr class="product-single-container">
                                                    <th class="product-select">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="check_list[]" value="<?php echo $row["supplier_id"]; ?>" class="cat-check">
                                                            </label>
                                                        </div>
                                                    </th>
                                                    <td class="product-id"><span><?php echo ($numOrder++); ?></span></td>

                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["supplier_name"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name"><a href="tel:<?php echo $row["supplier_phone_no"]; ?>"><?php echo $row["supplier_phone_no"]; ?></a></div></td>    
                                                    <td class="product-name-td"><div class="product-name"><a href="mailto:<?php echo $row["supplier_contact_email"]; ?>"><?php echo $row["supplier_contact_email"]; ?></a></div></td>
                                                    <td class="product-actions">
                                                        <a href="edit.php?id=<?php echo $row["supplier_id"]; ?>" class="product-actions-btn product-actions-edit"><i class="material-icons">mode_edit</i><span>Edit</span></a>
                                                        <a href="<?php echo $row["supplier_id"]; ?>" class="product-actions-btn product-actions-delete" id="supplier-actions-delete"><i class="material-icons">delete</i><span>Delete</span></a>
                                                    </td>
                                                </tr>
...
<script>
    ...
    $('a#supplier-actions-delete').click(function (e) {
        e.preventDefault();
