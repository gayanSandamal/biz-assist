                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title"><a href="<?php echo $baseUrl; ?>/views/brands/" class="back-btn"><i class="material-icons">arrow_back</i></a>Add Brands</h4>
                            ...
                            <form class="min-height-form" method="get" action="add-brand-call.php">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Generics name</label>
                                ...
                                <button type="submit" class="btn btn-primary pull-right add-brand-button" id="add-brand-button">Add Generics</button>
                                <div class="clearfix">
                                </div>
                            </form>
                        </div>
