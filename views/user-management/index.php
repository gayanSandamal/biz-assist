...
$result_view_users = $conn->query($view_users);
?>
                        ...
                        <form method="POST" action="delete-multiple.php">
                            ...
                            <div class="card-content table-responsive">
                                <table class="table hover" id="cat-table">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($result_view_users->num_rows > 0) {
// output data of each row
                                            $numOrder = 1;
                                            while ($row = $result_view_users->fetch_assoc()) {
                                                ?>
                                                ...
                                                <tr class="product-single-container">
                                                    <th class="product-select">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="check_list[]" value="<?php echo $row["user_id"]; ?>" class="cat-check">
                                                            </label>
                                                        </div>
                                                    </th>
                                                    ...
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["username"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["first_name"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["last_name"]; ?></div></td>
                                                    ...
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["user_level"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["branch_name"]; ?></div></td>
                                                    <td class="product-name-td"><div class="product-name"><?php echo $row["branch_location"]; ?></div></td>
                                                    
                                                    <td class="product-actions">
                                                        <a href="edit.php?id=<?php echo $row["user_id"]; ?>" class="product-actions-btn product-actions-edit"><i class="material-icons">mode_edit</i><span>Edit</span></a>
                                                        <!--<a href="<?php // echo $row["user_id"]; ?>" class="product-actions-btn product-actions-delete" id="product-actions-delete"><i class="material-icons">delete</i><span>Delete</span></a>-->
                                                    </td>
                                                </tr>
